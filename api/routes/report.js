...
const GET_USERS_WITH_MORE_TRACKS_REGISTER = "SELECT u.Name, count(u.UserId) as TracksRegister FROM TrackAddHistory tah INNER JOIN AppUser u ON u.UserId = tah.UserId GROUP BY u.UserId ORDER BY count(u.UserId) DESC LIMIT 5";
