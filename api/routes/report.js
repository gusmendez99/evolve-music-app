...
const GET_MOST_COLLABORATIVE_ARTIST = "select a1.name, count(a1.name) from album al1 join artist a1 on al1.artistid = a1.artistid join track t1 on t1.composer = ar1.name group by a1.name order by count(a1.name) desc limit 10";
